  ...
  <div class="mb-6">
    <div class="flex gap-2">
      <button
        ...
        class="px-4 py-2 rounded-lg text-sm font-semibold transition-all {selectedMode === '' ? 'bg-teal-500/15 text-teal-300 border border-teal-500/30' : 'theme-inline-surface theme-muted hover:border-teal-500/20'}"
      >
        Все режимы
      </button>
      <button
